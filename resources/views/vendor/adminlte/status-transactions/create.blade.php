...
@section('title', '| Create New Status Transaction')
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form action="/status-transactions" method="post" data-toggle="validator" role="form">
                ...
                <input type="submit" value="Create Status Transaction" class="btn btn-success btn-lg btn-block" id="add" style="margin-top: 70px;">
            </form>
        </div>
    </div>
@endsection
