...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-md-offset-2" style="padding: 20px; box-shadow: 0 0px 0.1px rgba(0,0,0,0.6);">

                    <hr>

                    <form action="/status-products" method="post" data-toggle="validator" role="form">
                        {{ csrf_field() }}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#brand-title').text("Create Status Product")
