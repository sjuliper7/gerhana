...
@section('content')
    <div class="home"style="max-height: 15em;">
        <div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/.jpg">
            <img src="images/banner_background.png"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <img class="" src="{{asset('images/location_icon.png')}}"
                                             style="max-height: 80%;max-width: 80%;margin-left: 0em">
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <div class="row" style="margin-top: 1em">
                            ...
                            <a href="{{ URL::to('list-transactions/' . $store->id ) }}">
                                <button type="button" class="btn btn-primary"
                                        style="margin: 0.5em;background-color: #8b0000">List Transaction
                                </button>
                            </a>

                            <button type="button" class="btn btn-secondary"
                                    style="margin: 0.5em;background-color: #8b0000">Menu 2
                            </button>
                            <button type="button" class="btn btn-success"
                                    style="margin: 0.5em;background-color: #8b0000">Menu 3
                            </button>
                            <a href="{{url('owner-products/create')}}">
                                <button type="button" class="btn btn-primary"
                                        style="margin: 0.5em;background-color: #8b0000">Tambah Produk
                                </button>
                            </a>
                        </div>
                                    ...
                                    <div class="product_item discount">
                                        ...
                                        <div class="product_content">
                                            ...
                                            <div class="product_name">
                                                <div><a href="product.html" tabindex="0">{{$product->name}}</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
